...
\afterpreface
  ...
  \include{vision_and_technical_strategy}                  
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
        
  \include{implementation_report}                  
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
        
  \include{scenario_validations}                  
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
...
\bibliography{refs/references,refs/references_another,refs/articles,refs/inproceedings,refs/misc,refs/manual}
